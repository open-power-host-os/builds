...
class TestConfigParser(unittest.TestCase):
    ...
    @parameterized.expand([
        ...
        (['build-package', '--packages-repos-target-path=foo'], 'packages_repos_target_path', 'foo'),
        (['build-package', '--keep-builddir'], 'keep_builddir', True),
        (['build-package', '--packages-metadata-repo-url=foo'], 'packages_metadata_repo_url', 'foo'),
        (['build-package', '--packages-metadata-repo-branch=foo'], 'packages_metadata_repo_branch', 'foo'),
    ...
    @parameterized.expand([
        ...
        (['build-package'], 'packages_repos_target_path', '/var/lib/host-os/repositories'),
        (['build-package'], 'packages_metadata_repo_url', None),
        (['build-package'], 'packages_metadata_repo_branch', None),
